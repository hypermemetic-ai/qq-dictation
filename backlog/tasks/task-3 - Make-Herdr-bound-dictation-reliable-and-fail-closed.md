...
- [ ] #6 The local release build serializes Cargo and CMake inside a Docker hard limit of 5 GiB total memory with no container swap and 2 CPUs, failing locally rather than causing global OOM
<!-- AC:END -->
